...
当前版本：APK 本地版 V0.3.1 发布候选 + 已封存的小程序 V0。
...
它用于生成 Android 本地安装包。当前安卓端支持食品列表、新增、编辑、删除、本地存储、`expiryDate` 排序、状态筛选、分类筛选、内置实时商品码扫码、图库条码/二维码图片识别与商品信息查询、智能提醒计划、每日简报、系统通知和已用完归档。发布候选版本已移除示例数据加载和测试提醒入口。
...
当前 APK 版本仍不实现云数据库、账号体系、多设备同步、OCR、AI 或云端订阅消息。
